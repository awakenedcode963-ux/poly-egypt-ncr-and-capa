      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full p-6 sm:p-8 space-y-6 shadow-2xl border border-slate-200 my-8">
        ...
        <div className="space-y-4 text-sm text-slate-700">
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
            ...
            <ul className="list-disc list-inside text-xs text-slate-600 space-y-1 pr-4">
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
            <span className="font-bold text-slate-900 flex items-center gap-2">
              <span className="w-6 h-6 bg-amber-500 text-slate-950 rounded-full flex items-center justify-center text-xs font-black">3</span>
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
            <span className="font-bold text-slate-900 flex items-center gap-2">
              <span className="w-6 h-6 bg-amber-500 text-slate-950 rounded-full flex items-center justify-center text-xs font-black">4</span>
