...
export const WorkerFloorScanModal: React.FC<WorkerFloorScanModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 dir-rtl font-sans animate-fade-in">
      <div className="bg-white text-slate-900 w-full max-w-xl rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[92vh]">
        ...
        <div className="p-4 sm:p-6 overflow-y-auto space-y-5 custom-scrollbar">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-right">
                  {sampleMachines.map((m) => (
                    ...
                    >
                      ...
                      <span className="text-[10px] text-slate-500 mt-0.5">{m.dept}</span>
                    </button>
                  ))}
                </div>
              </div>
          ...
          {step === 'form' && (
            <form onSubmit={handleSubmitReport} className="space-y-4 text-xs text-slate-900">
              {/* Scanned Badge */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl font-bold focus:ring-2 focus:ring-[#0B3A60] text-slate-900 placeholder-slate-400"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl font-bold text-slate-900 placeholder-slate-400"
                  />
                </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl font-black text-red-700 text-slate-900 placeholder-slate-400"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl font-medium text-slate-900 placeholder-slate-400"
                />
              </div>
              ...
              <div className="pt-2 flex items-center justify-end gap-2">
                <button
                  ...
                  onClick={() => setStep('scan')}
                  disabled={isLoading}
                  className="px-4 py-2.5 bg-white/10 hover:bg-white/20 text-slate-700 font-bold rounded-xl cursor-pointer disabled:opacity-50"
                >
                  إلغاء
                </button>
