    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/10 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-white">إدارة البيانات الأساسية (Master Data)</h2>
          </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-white font-bold text-xs shadow-sm transition-all cursor-pointer"
          >
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 z-50">
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl max-w-md w-full p-6 space-y-4 shadow-2xl border border-white/10">
            <div className="flex items-center justify-between border-b pb-3">
              <h3 className="font-bold text-lg text-white">إضافة عنصر جديد لـ {subTab}</h3>
            ...
            <form onSubmit={handleAddItem} className="space-y-4">
              {subTab !== 'inspectors' && (
                <div>
                  <label className="block text-xs font-semibold text-slate-200 mb-1">كود الصنف / العيب:</label>
                  <input
                    type="text"
                    required
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-200 mb-1">الاسم / المسمى بالعربي أو الإنجليزي:</label>
                <input
                  type="text"
                  required
              ...
              {subTab === 'fittings' && (
                <div>
                  <label className="block text-xs font-semibold text-slate-200 mb-1">الخامة (Material):</label>
                  <select
              ...
              {subTab === 'machines' && (
                <div>
                  <label className="block text-xs font-semibold text-slate-200 mb-1">نوع الماكينة:</label>
                  <select
                    value={newItemType}
              ...
              <div className="flex items-center justify-end gap-2 pt-2">
                <button
                  ...
                  className="px-4 py-2 rounded-lg border text-xs font-semibold text-slate-300 hover:bg-white/5"
                >
                  إلغاء
                </button>
                <button
