      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white/10 backdrop-blur-xl p-6 rounded-2xl border border-white/10 shadow-xs space-y-5">
          ...
          <div className="space-y-3 text-xs">
            <label className="block text-slate-200 font-bold">قائمة طلبات CAPA المسجلة:</label>
            <select
          ...
          <div className="border-t border-white/10 pt-4 space-y-3 text-xs">
            ...
            <div>
              <label className="block text-slate-300 mb-1 font-semibold">اسم الصنف / المنتج:</label>
              <input
                type="text"
                value={customProduct}
            ...
            <div>
              <label className="block text-slate-300 mb-1 font-semibold">سبب الحجز / عدم المطابقة:</label>
              <textarea
                value={customReason}
        ...
        <div className="lg:col-span-2 bg-white/10 p-6 rounded-2xl border border-white/10 flex flex-col items-center justify-center">
          <div id="printable-ncr-tag" className="bg-white text-slate-900 w-full max-w-md p-6 rounded-2xl border-4 border-[#0B3A60] shadow-2xl space-y-5 font-sans dir-rtl">
            ...
            {/* Signatures */}
            <div className="pt-3 border-t border-white/10 grid grid-cols-2 gap-2 text-[10px] text-slate-300 font-bold text-center">
              <div>
                <span>توقيع مهندس الجودة:</span>
                <div className="h-6 border-b border-white/20 mt-1" />
              </div>
              <div>
